...
## Исходники кода рамки, которая ходит в проксию в папке tft4
...
- 📤 **Тела запросов** (только в DEBUG): полное содержимое JSON/бинарных данных
- 📥 **Тела ответов** (только в DEBUG): полное содержимое до и после обработки
- 📋 **Заголовки ответов** (только в DEBUG): все HTTP заголовки
